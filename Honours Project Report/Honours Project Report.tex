...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Count number of edge pixels in $s_i$ and $s_{i-1}$
        \item Dilate and invert edges on $s_i$ and $s_{i-1}$
    ...
    \end{figure}
    \item Thresholds for classifying continuity: Finally, we must determine at what value of $d_i$ means that $f_i$ is a cut. There are many approaches to this problem, with 
